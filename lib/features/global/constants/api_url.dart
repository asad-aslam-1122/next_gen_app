class ApiUrl {
  ...
  static String getRouteBetweenCoordinate(latlng1, latlng2, mode, key) =>
      "https://maps.googleapis.com/maps/api/directions/json?origin=${latlng1.latitude},${latlng1.longitude}&destination=${latlng2.latitude},${latlng2.longitude}&modes=$mode&avoidHighways=false&avoidFerries=true&avoidTolls=false&key=$key";
